    ...
    <div
      ...
      className={`${
        isDark
          ...
          : "bg-amber-500/10 border border-amber-500/20 hover:bg-amber-500/5"
    ...
    >
      <div
        className={`w-[8vw] h-[8vw] lg:w-[4vw] lg:h-[4vw] xl:w-[2vw] xl:h-[2vw] flex justify-center items-center ${
          isDark ? "bg-amber-500/25" : "bg-amber-500/40"
        } rounded-md xl:rounded-lg`}
      >
        <MessageCircleQuestion width={25} height={25} className="text-amber-400" />
      </div>
      <div className="w-full flex flex-col items-start">
        <p className="font-bold text-xl md:text-2xl lg:text-xl xl:text-lg">AI FAQ Generator</p>
...
export default FaqgeneratorCard;
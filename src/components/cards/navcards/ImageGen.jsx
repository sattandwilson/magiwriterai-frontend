...
const ImageGenCard = ({ isDark, setShowTools }) => {
  ...
  return (
    ...
    >
      <div
        className={`w-[6vw] h-[6vw] lg:w-[4vw] lg:h-[4vw] xl:w-[2vw] xl:h-[2vw] flex justify-center items-center ${
          isDark ? "bg-orange-400/30" : "bg-orange-400/40"
        } rounded-md xl:rounded-lg`}
      >
        <Image width={25} height={25} className="text-orange-300 md:w-[4vw] md:h-[4vw] lg:w-[1.5vw] lg:h-[1.5vw]" />
      </div>
      <div className="w-full flex flex-col items-start">
        <p className="font-bold text-lg md:text-2xl lg:text-xl xl:text-lg">AI Image Generator</p>
        <p className="text-sm md:text-2xl lg:text-base xl:text-base">
